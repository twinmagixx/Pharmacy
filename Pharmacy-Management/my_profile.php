    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          //$username = ucword($_GET["USERNAME"]);
          updateAdminDetails($pharmacy_name , $address, $email, $contact_number);
         }
         function updateAdminDetails($pharmacy_name , $address, $email, $contact_number) {
          require "php/db_connection.php";
          $query = "UPDATE admin_credentials SET PHARMACY_NAME = '$pharmacy_name', address = '$address', EMAIL = $email, CONTACT_NUMBER = '$contact_number' WHERE USERNAME = $username";
          $result = mysqli_query($con, $query);
          if(!empty($result))
            showAdminDetails(0);
        }
